...
public:
	...
	*/
	...
	// 베이스 클래스 메서드를 오버라이드 하려했지만, 베이스 클래스에서 virtual 로 선언되지 않은 메서드였다.
	void go(); // virtual 이 아닌데 베이스 클래스와 겹치는 메서드 => 베이스 클래스 타입 입장에서 봤을 때, 베이스 클래스 메서드에 숨겨진다. 파생 클래스 내에서만 사용이 가능하다.
};
